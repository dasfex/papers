...
> Когда я говорю бизнес, понимаю любое место, где оказывают услуги: магазин, кафе, банк, нотариус, что угодно другое. Но вообще это может быть что угодно. Люди в сервисе вроде Tinder, курьеры в Лавке или таксист в Uber. 
...
Even grid -- это когда мы делим планету на равные (в некотором смысле) участки. Каждый участок надо захешировать некоторым образом, после чего по ним можно искать. 
...
В дефолтной реализации каждая нода дерева будет хранить координаты для левого верхнего и правого нижнего угло + 4 указателя на детей. И обычно такие индексы всегда in-memory. Это не беда, т.к. даже для большого количества объектов весить индекс будет единицы Гб.
...
Не будем глубоко закапываться в реализацию и детали, т.к. подобные вещи легко находятся. Но вот вам [визуализация](https://observablehq.com/@stardisblue/quadtree-vs-rtree) на потыкаться.

### Google S2

В отличие от других решений, где карта проецируется на плоскость, Google S2 работает с планетой как сферой. Это позволяет сэкономить некоторое количество ресурсов и меньше "врать" из-за трейдофов проеции Земли на плоскость. 
...
- Redis умеет что-то делать из коробки. 
