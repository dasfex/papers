...
Прямоугольник на картиночке геохешом будет записываться как `11110 01001 01110 01101 01101`. После конвертации через base32 получим `u9edd`. И логично, что регулируя длину геохеша, мы можем регулировать точность:
